...
- `JNIEnv::from_raw` now explicitly checks that the JNI version is >= 1.2 since the crate needs to be able to assume it can check for exceptions ([#478](https://github.com/jni-rs/jni-rs/issues/478)
